      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 text-xl">
          ...
          <details className="dropdown">
            <summary className="mt-2 border-none">Category</summary>
            <ul className="p-2 shadow menu dropdown-content z-[1] bg-gray-100 rounded-box w-52">
              ...
              <li><a href="/fashion">Fashion Photography</a></li>
              <li><a href="/portrait">Portrait Photography</a></li>
              <li><a href="/drone">Drone Photography</a></li>
            </ul>
          </details>
          {
            user?.email === 'ismailtawhid@gmail.com' ?
              <>
                <li><a href="/addServices">Add Services</a></li>
                <li><a href="/allBooking">All Bookings</a></li>
              </>
              :
              <></>
          }
      ...
      <div className="navbar-end">
        {
          user?.email ?
            <>
              {
                user?.email !== 'ismailtawhid@gmail.com' ?
                  <a href="/myBooking" className=" me-56 pr-10">My Bookings</a>
                  :
                  <></>
            }
