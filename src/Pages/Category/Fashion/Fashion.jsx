...
import img1 from '../../../images/category/fashion/fashion1.jpg'
import img2 from '../../../images/category/fashion/fashion2.jpg'
import img3 from '../../../images/category/fashion/fashion3.jpg'
import img4 from '../../../images/category/fashion/fashion4.jpg'
import img5 from '../../../images/category/fashion/fashion5.jpg'
import img6 from '../../../images/category/fashion/fashion6.jpg'
const Fashion = () => {
    return (
                ...
                <div className="card w-full shadow-2xl bg-fuchsia-200">
                    ...
                    <div className="card-body items-center text-center text-black font-xl">
                        ...
                        <div className="card-actions">
                            <Link to='/fashionService'><button className="btn px-28 btn-primary">Go for Booking</button></Link>
                        </div>
                    </div>
                </div>
                <div className="card w-full shadow-2xl bg-fuchsia-200">
